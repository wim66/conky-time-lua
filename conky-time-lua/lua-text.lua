...
# by +WillemO @wim66				                 	#
# 28-dec-16					                         	#
# v2 12-June-2024  (removed radial gradient)			#
#########################################################
]]
...
v1.3	25/06/2010  Add "reflection_alpha", "reflection_length", "reflection_scale", 
                    "skew_x" et "skew_y"
wim66   12/06/2024 Removed radial gradient, added optins for linear gradient
...
function conky_draw_text()
    ...
    text_settings = {
        {
            text = "9          2",
            font_name = "Christmas Time Personal Use",
            font_size = 90,
            h_align = "c",
            bold = false,
            x = 280,
...

        {
            ...
            linear_gradient = {150, 80, 150, 120},
            v_align = "m",
        },

        {
            ...
            orientation = "nn",
            colour = {{0, 0xFF0000, 1}, {0.5, 0xFFFFFF, 1}, {1, 0x0000FF, 1}},
            linear_gradient = {150, 190, 150, 200},
        },

        {
            ...
            reflection_scale = 1.5,
            colour = {{0, 0xFF0000, 1}, {0.5, 0xFFFFFF, 1}, {1, 0x0000FF, 1}},
            linear_gradient = {150, 230, 150, 280},
        },
    }
